...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _controlErrors() {
    setState(() {
      _emailError =
          _emailTextController.text.isEmpty ? 'Insert email address' : null;
      _passwordError =
          _passwordTextController.text.isEmpty ? 'Insert password' : null;
    });
  }
                ...
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Select suitable Language from below',
                        style: GoogleFonts.roboto(
                          fontSize: 14,
                          fontWeight: FontWeight.w300,
